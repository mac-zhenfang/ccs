...
public class Main {
    ...
    private static String API_KEY = "759ozv9nj6rype";
    private static String API_SECRET = "hOcv1vc3TFl5DQG3";
    ...
    public static void main(String[] args) throws IOException {
       ...
       url = "http://api.linkedin.com/v1/people-search:(people:(first-name,last-name,headline),facets:(code,buckets))";
        request = new OAuthRequest(Verb.GET, url);
        request.addQuerystringParameter("title", "D¨¦veloppeur");
...
//        System.out.println();System.out.println();
        ...
        File newFile = new File("C:\\linkin");
        if(!newFile.exists())
        ...
        //https://developer.linkedin.com/documents/field-selectors
        url = "https://api.linkedin.com/v1/people/~/connections:(first-name,last-name,headline,pictureUrl)?format=json";
        request = new OAuthRequest(Verb.GET, url);
        service.signRequest(accessToken, request);
        response = request.send();
        System.out.println(response.getHeaders().toString());
